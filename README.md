...
# FORMAT: SEMINAR_GUIDE (Скорректированная Методичка)
...
## ПАРА 1. ОТ «ЛАБОРАТОРНОЙ» К «КУРСОВОЙ» (АРХИТЕКТУРА) (08:30 – 10:05)
...
## ПАРА 2. SELF-HACKING: АУДИТ ТОГО, ЧТО НАПИСАЛИ (10:15 – 11:50)
